---
title: "Omixer: Multivariate and reproducible randomization for
    omics measurements with lab-friendly sample layouts"
author: 
- Lucy Sinke
- Davy Cats
- Bas Heijmans
...
knitr::include_graphics(path=
    "https://github.com/molepi/Omixer/blob/master/vignettes/omixer_48col.png")
```
...
knitr::include_graphics(path=
    "https://github.com/molepi/Omixer/blob/master/vignettes/omixer_48row.png")
```
...
knitr::include_graphics(path=
    "https://github.com/molepi/Omixer/blob/master/vignettes/omixer_48colblock.png")
```
...
The layout above was generated with a seed of 63936.

```{r omixer_specific_rna, eval=FALSE}
omixerLayout <- omixerSpecific(sampleList, sampleId="sampleId", 
    block="block", seed=63936, wells=96, div="row", 
    plateNum=1, randVars=randVars)
```
...
```{r example_sheet_rna, fig.wide = TRUE, out.width = '100%', echo=FALSE}
knitr::include_graphics(path=
    "https://github.com/molepi/Omixer/blob/master/vignettes/omixer_sample_sheets_rna.PNG")
```
...
`seed` in the `omixerSpecific` function. The layout above was generated with a 
seed of 43956, so we could regenerate it using the following code.
...
knitr::include_graphics(path=
    "https://github.com/molepi/Omixer/blob/master/vignettes/omixer_sample_sheets_dna.PNG")
```
